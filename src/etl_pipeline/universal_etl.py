...
if __name__ == "__main__":
    ...
    engine.process_press_brake(hydraulic_dir_name="data/chanTon")
    
    # 2. Xử lý dữ liệu va đập Máy Đột Dập nằm ngoài thư mục gốc
    engine.process_punching_machine(file_name="data/dotDap/tool_wear_dataset.csv")
    
    # 3. Xử lý dữ liệu quang nhiệt Máy Cắt Laser nằm ngoài thư mục gốc
    engine.process_laser_cutting(file_name="data/catLaser/ai4i2020.csv")
    
    # 4. Xử lý chuỗi thời gian lỗi trạm Máy Hàn Robot nằm ngoài thư mục gốc
    engine.process_welding_robot(file_name="data/hanRobot/predictive_maintenance_v3.csv")
